...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.8_x64\ispfpga\bin\nt64\scuba.exe -w -n ipcore -lang verilog -synth lse -arch xo2c00 -type pll -fin 133 -fclkop 100 -fclkop_tol 1.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -fracn 164  */
/* Thu Jan 19 17:02:05 2017 */


`timescale 1 ns / 1 ps
module ipcore (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    ...
    defparam PLLInst_0.FRACN_DIV = 164 ;
